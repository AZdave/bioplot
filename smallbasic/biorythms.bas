...
LABEL Help 
PRINT "xxxxxxxxxxxx - 27 August 2004"
PRINT "             - Version 1.10" 
PRINT "" 
...
ystep=0.75
LABEL cplot
color 7  '' 20220131 white to show up on black background
...
'' X-axis 
line 0,y0,xmax,y0 
OPEN "data_bio.csv" FOR OUTPUT AS #1
PRINT #1, "Days,Physical,Emotional,Intellectual,Intuitional,Average,Mastery,Passion,Wisdom" 
for i = 1 to 31 
   x=xmax*i/31 
   y1=y0-.01*ymax 
   y2=y0+.02*ymax 
...
for x=0 to xmax-1 step xstep 
   ...
   pa=(ph+em)/2
   wi=(em+il)/2
   PRINT #1, age,",",ph,",",em,",",il,",",it,",",av,",",ma,",",pa,",",wi
...
'' X-axis 
line x0,0,x0,ymax 
OPEN "data_biol.csv" FOR OUTPUT AS #2
PRINT #2, "Days,Physical,Emotional,Intellectual,Intuitional,Average,Mastery,Passion,Wisdom" 
for i = 1 to 31 
   y=ymax*i/31 
   x1=x0-.01*xmax 
   x2=x0+.02*xmax 
...
for y=0 to ymax-1 step ystep 
   ...
   pa=(ph+em)/2
   wi=(em+il)/2
   PRINT #2, age,",",ph,",",em,",",il,",",it,",",av,",",ma,",",pa,",",wi
